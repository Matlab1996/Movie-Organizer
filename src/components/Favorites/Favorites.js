...
export default function Favorites({favoriteList, title}) {
    ...
    return (
        <div className="favorites">
            <input id='listName' placeholder="New list" className="favorites__name" onChange={onChangeHandler} />
            ...
            {
                (saveList) ?
                <button type="button" className="favorites__save" onClick={onSaveHandler} disabled={(title && favoriteList) ? false : true}>Save list</button>
                :
